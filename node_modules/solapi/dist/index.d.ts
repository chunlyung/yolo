...
declare const requestSendOneMessageSchema: Schema.extend<Schema.SchemaClass<{
    ...
    readonly voiceOptions?: {
        ...
        readonly replyRange?: 2 | 1 | 3 | 4 | 5 | 6 | 7 | 8 | 9 | undefined;
    ...
    to: Schema.Union<[Schema.transform<typeof Schema.String, typeof Schema.String>, Schema.Array$<Schema.transform<typeof Schema.String, typeof Schema.String>>]>;
    from: Schema.optional<Schema.transform<typeof Schema.String, typeof Schema.String>>;
}>>;
/**
 * 메시지 발송 요청 모델
